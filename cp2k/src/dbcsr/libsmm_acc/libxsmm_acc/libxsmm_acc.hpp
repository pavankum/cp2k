...
# define LIBXSMM_ACC_PREFETCH_A LIBXSMM_PREFETCH_A
# define LIBXSMM_ACC_PREFETCH_B LIBXSMM_PREFETCH_B
# define LIBXSMM_ACC_PREFETCH_C LIBXSMM_PREFETCH_C
# define LIBXSMM_ACC_PREFETCH LIBXSMM_PREFETCH
...
# define LIBXSMM_ACC_PREFETCH_A(EXPR)
# define LIBXSMM_ACC_PREFETCH_B(EXPR)
# define LIBXSMM_ACC_PREFETCH_C(EXPR)
# define LIBXSMM_ACC_PREFETCH 0
